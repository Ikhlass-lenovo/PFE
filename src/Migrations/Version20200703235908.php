 ...
 */
final class Version20200703235908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, activation_token VARCHAR(255) DEFAULT NULL, reset_password_token VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gps_histo (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_android INT NOT NULL, ip_wan VARCHAR(255) NOT NULL, ip_mac VARCHAR(255) NOT NULL, nom_user VARCHAR(255) NOT NULL, nom_machine VARCHAR(255) NOT NULL, localisation VARCHAR(255) NOT NULL, date_update DATETIME NOT NULL, ip_lan VARCHAR(255) NOT NULL, date_install DATETIME NOT NULL, latitude_gps DOUBLE PRECISION NOT NULL, longitude_gps DOUBLE PRECISION NOT NULL, altitude_gps DOUBLE PRECISION NOT NULL, accuracy_gps DOUBLE PRECISION NOT NULL, provider_gps VARCHAR(255) NOT NULL, bearing_gps DOUBLE PRECISION NOT NULL, speed_gps DOUBLE PRECISION NOT NULL, elapsedrealtimeannos_gps VARCHAR(255) NOT NULL, INDEX IDX_7D868BF06B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE travailleur (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, password VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, photo_profil VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
